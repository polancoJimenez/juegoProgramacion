        ...
        while (doom.salud > 0 && hank.salud > 0) {
            ...
            switch (eleccion) {
                case 1:
                    ...
                    int dañoheroe = doom.ataque();
                    System.out.println(doom.nombre + " ataca a " + hank.nombre + " causando " + dañoheroe + " puntos de daño.");
                    hank.recibirDaño(dañoheroe);
                    break;
                case 2:
            ...
            if (hank.salud > 0) {
                int dañoEnemigo = hank.ataqueAleatorio();
                System.out.println(hank.nombre + " ataca a " + doom.nombre + " causando " + dañoEnemigo + " puntos de daño.");
                doom.recibirDaño(dañoEnemigo);
            }
